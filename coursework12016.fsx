...
let unis = [(“http://www.ttu.ee”,1918);(“http://www.ut.ee”,1632);(“http://www.tlu.ee”,1919)]
...
let datam = [("Cats",4);("Dogs",5);("Mice",3)("Elephants",2)]
let res = datam |> List.filter (fun (nm,x) -> nm.Length <= 4)
